...
use App\Mail\ShipmentBookedMail;
...
// }
    ...
    // Send booking confirmation emails to sender and receiver
    if ($request->boolean('send_email_notifications')) {
        Mail::to($shipment->shipper_email)->send(new ShipmentBookedMail($shipment, 'sender'));
        Mail::to($shipment->receiver_email)->send(new ShipmentBookedMail($shipment, 'receiver'));
    }
